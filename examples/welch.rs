...
fn main() {
    ...
    {
        let test_res_lt = welch_test(&moments_x, &moments_y, AltHyp::Lt, ALPHA);
    ...
    {
        let test_res_gt = welch_test(&moments_x, &moments_y, AltHyp::Gt, ALPHA);
    ...
    {
        let ci = welch_ci(&moments_x, &moments_y, ALPHA);
